...
const ExperimentalLinePopulationConfig& CoreView::experimental_line_population_config() const {
  return state_.runtime_.cache_state.experimental_line_population;
}
