...
| support-layout authority/seed/projection inspection | public inspection surface と旧 layout/endpoint/semantic alias family は削除済み | recalc/cache internals に authority/seed record が残る | inspection へ戻さず、recalc family の退役時に内部 contract を削除 |
